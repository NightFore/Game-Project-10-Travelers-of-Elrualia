...
CHARACTER_DICT = {"layer": 3,
                  "player": {"name": "Player", "pos": [220, 320], "grid_pos": [0, 0],
                             ...
                             "table": True, "reverse": False, "size": [192, 192], "animation_time": 0.150,
...
SPELL_DICT = {"layer": 2,
              "energy_ball": {"image": "effect_pimen_EnergyBall_128x128.png", "side": 0, "center": True, "bobbing": False, "flip": False,
                              "table": True, "reverse": False, "size": [128, 128], "animation_time": 0.025,
                              "impact": {"image": "effect_pimen_EnergyBall_Impact_128x128.png", "side": 0, "center": True, "bobbing": False, "flip": False,
                                         "table": True, "reverse": True, "size": [128, 128], "animation_time": 0.025},
